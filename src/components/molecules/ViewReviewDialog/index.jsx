      ...
      <DialogContent>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, paddingY: 2 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            <RouteText sx={{ fontSize: '14px', fontWeight: 500, color: '#374151' }}>
              Sua nota
            </RouteText>
          ...
          {review?.text && (
            <Box>
              ...
              >
                <RouteText sx={{ fontSize: '14px', color: '#374151', lineHeight: 1.6 }}>
                  {review.text}
                </RouteText>
              </Box>
            </Box>
          ...
          {!review?.text && (
            ...
            >
              <RouteText sx={{ fontSize: '14px', color: '#6B7280', fontStyle: 'italic' }}>
